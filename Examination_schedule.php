...
<br>
<!-- Schedule table displayed here-->
<h1 style="text-align: center; color: #1111aa;">Examination schedule</h1>
<h3 style="text-align: left; color: black;">&nbsp;&nbsp;Choose exam</h3>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<form method ="post">
<div style='padding:10px;'>
<select name="exam">
	<option value="NULL">--Choose exam type--</option>
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	if(isset($_POST['submit']))
	{
		...
		else
		{
			$user=$_SESSION["id"];
			$exam=$_POST['exam'];
			$sql = "SELECT id,sub,dates,type FROM schedule WHERE id = '$user' and type = '$exam'";
			$res = mysqli_query($db,$sql);
			echo "<center>";
			echo "<table style='border: 1px solid blue; border-collapse: collapse; width:80%;'>";
			echo"<tr>";
			echo "<th style='border: 1px solid blue;'>Exam Type</th>";
			echo "<th style='border: 1px solid blue;'>Subject</th>";
			echo"<th style='border: 1px solid blue;'>Date</th>";
			echo "</tr>";
			while($row = mysqli_fetch_array($res))
			{
				echo "<tr>";
				echo "<td style='border: 1px solid blue;'> $exam </td>";
				echo "<td style='border: 1px solid blue;'>" . $row['sub'] . "</td>";
				echo "<td style='border: 1px solid blue;'>" . $row['dates'] . "</td>";
				echo "</tr>";
			}
			echo "</table>";
			echo "</center>";
