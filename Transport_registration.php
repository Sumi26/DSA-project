...
<br>
<h1 style="text-align: center; color: #1111aa;">Transport registration</h1>
<h3 style="text-align: left; color: black;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Choose route</h3>
<form method="post">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name="route">
  ...
  <option value="Route 3">Route 4</option>
  <option value="Route 3">Route 5</option>
</select>
<br>
<br>
