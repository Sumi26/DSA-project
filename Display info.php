...
define('DB_SERVER', 'localhost');
	...
	session_start();
	$user=$_SESSION["id"];
	$sql = "SELECT id,name,class,roll,section FROM profile WHERE id = '$user'";
...
<h1 style="text-align: center; color: #1111aa;">Display information</h1>
<div style="text-align:center; padding:50px; ">
<h3 style="text-align:left;color:#0066ff;">  Name:<div id='page' style='width: 500px'>
<?php
echo "<h5 style='border:2px aliceblue solid; font-size:21px;'>".$name."</h5>";
?>
</div>
</h3>
<h3 style="text-align:left;color:#0066ff;"> Roll number:<div id='page' style='width: 500px'>
<?php
echo "<h5 style='border:2px aliceblue solid; font-size:21px;'>$roll</h5>";
?>
</div>
</h3>
<h3 style="text-align:left;color:#0066ff;">  Class:<div id='page' style='width: 500px'>
<?php
echo "<h5 style='border:2px aliceblue solid; font-size:21px;'>$class</h5>";
?>
</div>
</h3>
<h3 style="text-align:left;color:#0066ff;">  Section:<div id='page' style='width: 500px'>
<?php
echo "<h5 style='border:2px aliceblue solid; font-size:21px;'>$section</h5>";
?>
</div>
</h3>
</div>
